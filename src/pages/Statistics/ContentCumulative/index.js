...
// containers
import StatsContainer from 'containers/Statistics/ContentCumulative';
// components
...
const ContentCumulative = () => {
  ...
  return (
    <Page className={classes.root} title="콘텐츠 수 – 일반유저 가입수">
...
export default ContentCumulative;
