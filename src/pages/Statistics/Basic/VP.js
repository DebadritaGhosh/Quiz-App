...
// containers
import StatsContainer from 'containers/Statistics/Basic/VP';
...
const VPStatistics = () => {
  ...
  return (
    <Page className={classes.root} title="사용자 통계 - VP">
      <Container maxWidth={false}>
        <Typography variant="h3" color="textPrimary">
          사용자 통계 - VP
        </Typography>
        <StatsContainer.Filter filter={filter} pagination={pagination} />
        <StatsContainer.Graph filter={filter} pagination={pagination} />
