  ...
  return (
    <Page className={classes.root} title="FAQ">
      <Container maxWidth={false}>
        ...
        <FAQContainers.Filter pagination={pagination} filter={filter} />
        <Box mt={3}>
          <Box className={classes.buttons} pt={1}>
            ...
            <div className={classes.buttons2}>
              ...
              <Button
                variant="outlined"
                color="primary"
                onClick={() => history.push('/faq/register')}
              >
                신규등록
              </Button>
            </div>
          </Box>
          <FAQContainers.Table pagination={pagination} filter={filter} />
        </Box>
      </Container>
      <ManageCategory title="FAQ 카테고리 설정" open={open} setOpen={setOpen} />
    </Page>
  );
};
