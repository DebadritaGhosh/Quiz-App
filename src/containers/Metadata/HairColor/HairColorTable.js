...
const th = [
  ...
  { key: 'nameKor', label: '컬러명(국문)', sortable: true },
  { key: 'nameEng', label: '컬러명(영문)', sortable: true },
  { key: 'colorCode', label: '컬러코드', sortable: true },
            ...
            {data.map((item, index) => {
              return (
                <TableRow
                  ...
                  hover
                  onClick={() =>
                    history.push(`${match.url}/hair-color/${item._id}`)
                  }
                >
